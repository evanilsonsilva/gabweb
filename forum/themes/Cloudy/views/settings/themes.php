...
?>
    <div class="Help Aside">
        ...
        echo '<ul>';
        echo wrap(Anchor(t('Get More Themes	'), 'http://www.themesteam.com'), 'li');
...
<a href="http://www.themesteam.com" class="SmallButton">Get More Themes</a>
</div>
...
<style>
.CurrentTheme .Description:before {margin:10px;color:#DC0000;display:block;content:"Copyright Removal not Allowed for free versions. You cannot redistribute, resell, lease, license, sub-license or offer our resources to any third party. This includes uploading our resources to another website, marketplace or media-sharing tool, and offering our resources as a separate attachment from any of your work. Only for personal projects!";}
</style>	
