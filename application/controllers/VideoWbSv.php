...
class VideoWbSv extends CI_Controller
{
    ...
    public function processaCadastrar()
    {
        ...
        if ($this->VideoModel->insert($titulo, $descricao, $especialidade, $link)) {
    ...
    public function processaAtualizar($id)
    {
        ...
        $link = $this->input->post('link');
        $this->load->model('VideoModel');
        if ($this->VideoModel->update($titulo, $descricao, $especialidade, $link)) {
